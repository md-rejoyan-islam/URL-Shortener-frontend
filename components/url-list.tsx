...
export function UrlList() {
  ...
  useEffect(() => {
    ...
    const mockUrls: UrlItem[] = [
      ...
      {
        id: "2",
        originalUrl: "https://verylongwebsiteaddress.com/with/many/parameters?param1=value1&param2=value2",
          ...
          <table className="w-full caption-bottom text-sm">
            <thead>
              <tr className="border-b transition-colors hover:bg-muted/50">
                <th className="h-12 px-4 text-left font-medium">Original URL</th>
